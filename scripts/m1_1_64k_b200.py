"""M1.1-64K — Decode SSD I/O byte trace at 64K context on B200.
...
CTX = 65536
log(f"M1.1-64K -- Decode SSD I/O at {CTX} context on B200")
...
result = {
    "measurement": f"M1.1-64K -- Decode SSD I/O at {CTX} context on B200",
    "date": "2026-05-27",
...
out_file = f"results/phase3/m1_1_decode_64k_b200.json"
